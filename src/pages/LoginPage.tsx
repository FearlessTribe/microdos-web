        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            <Link to="/" className="inline-flex items-center space-x-2">
              ...
              <span className="text-2xl font-soft font-semibold bg-gradient-to-r from-calm-turquoise-600 to-calm-lilac-600 bg-clip-text text-transparent">
                Microdos.in
              </span>
            </Link>
          </div>
          ...
          <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm rounded-3xl border border-white/40">
            <CardHeader className="text-center">
              <CardTitle className="text-2xl font-soft font-light text-slate-800">
                Willkommen zurück
              </CardTitle>
              ...
              */}
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="email" className="font-soft text-slate-700">
                    E-Mail
                  </Label>
                  <Input
                    id="email"
                ...
                <div className="space-y-2">
                  <Label
                    htmlFor="password"
                    className="font-soft text-slate-700"
                  >
                    Passwort
                  </Label>
                  <div className="relative">
              ...
              <div className="text-center text-sm">
                <span className="text-slate-600 font-soft">
                  Noch kein Konto?{' '}
                </span>
                <Link
                  to="/signup"
                  className="text-calm-turquoise-600 hover:text-calm-turquoise-700 hover:underline font-medium font-soft"
                >
                  Registrieren
                </Link>
              </div>
          ...
          <div className="text-center mt-6 text-sm text-slate-600 font-soft">
            ...
            <Link
              to="/terms"
              className="text-calm-turquoise-600 hover:text-calm-turquoise-700 hover:underline"
            >
              Nutzungsbedingungen
            </Link>{' '}
            und der{' '}
